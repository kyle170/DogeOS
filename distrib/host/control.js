...
(function (TSOS) {
    var Control = (function () {
        ...
        Control.readyQueueUpdate = function () {
            var output = "<tr style='font-size: 0.775em;padding: 0px;'><th>PID</th><th>Swap</th><th>State</th><th>PC</th><th>Acc</th><th>X</th><th>Y</th><th>Z</th><th>Base</th><th>Turn</th><th>Wait</th></tr>";
            ...
            var output = '<tr style="font-size: 0.775em;padding: 0px;"><th>PID</th><th>State</th><th>PC</th><th>X</th><th>Y</th><th>Z</th><th>Base</th><th>Turn</th><th>Wait</th></tr>';
            for (var i = 0; i < _ProcessManager.ResidentList.length; i++) {
                var processcontrolblock = _ProcessManager.ResidentList[i];
        ...
        Control.CPUModeSet = function (mode) {
